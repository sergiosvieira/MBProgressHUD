...
- (void)layoutSubviews {
    ...
    NSDictionary * fontAttributes = [NSDictionary dictionaryWithObject:label.font forKey: NSFontAttributeName];
    CGSize labelSize = [label.text sizeWithAttributes:fontAttributes];
    ...
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading
